...
I started this project when I was 14 because I genuinely missed Google+ and couldn't find anything that felt like it. Circles, Communities, +1s, Ripples — all of it. So I rebuilt it from scratch. It's not perfect but it works, and now it's open source so you can make it better than I can.
